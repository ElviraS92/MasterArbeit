...
parameters.t_res_1=x(2);
parameters.t_res_3=x(2); % same residence time for both phases
...
[calc_values.alpha_integral_1, calc_values.alpha_mean_1, calc_values.alpha_WS_1, calc_values.alpha_beddry_1, calc_values.alpha_WP_1] =calc_heat_transfer_coefficient(...
	calc_values.T_m_1,              ...
	input_values.C,             ...
	constants.R,                ...
	input_values.M,             ...
...
calc_values.delta_p_ms_tot_1=calc_delta_p_ms_tot(calc_values.delta_p_ms_1, parameters.hx_type);
...
calc_values.n_channels = calc_n_channels(...
    input_values.depth_hx,...
...
calc_values.m_ms_1hx=calc_m_ms_1hx(...
    calc_values.m_cs_ms_1ch_1,...
    calc_values.n_channels...
);

calc_values.m_CaO_1hx=calc_m_bed_1hx(calc_values.m_cs_CaO_1ch_1,calc_values.n_channels);
calc_values.n_plate_hx_tot_1= calc_n_plate_hx_tot(input_values.m_CaO_1, calc_values.m_CaO_1hx);
...
% molten salt mass flow for phase 3
calc_values.m_cs_ms_1ch_3=calc_values.m_cs_ms_1ch_1;
...
[calc_values.alpha_integral_3, calc_values.alpha_mean_3, calc_values.alpha_WS_3, calc_values.alpha_beddry_3, calc_values.alpha_WP_3] =calc_heat_transfer_coefficient(...
	calc_values.T_m_3,              ...
	input_values.C,             ...
	constants.R,                ...
	input_values.M,             ...
...
% cross section area for molten salt in one channel
...
calc_values.w_ms_3=calc_w_ms_3(...
    calc_values.m_cs_ms_1ch_3,...
    calc_values.rho_ms_3,...
...
calc_values.delta_p_ms_tot_3=calc_delta_p_ms_tot(calc_values.delta_p_ms_3, parameters.hx_type);
...
calc_values.m_CaCO3_1hx=calc_m_bed_1hx(calc_values.m_cs_CaCO3_1ch_3,calc_values.n_channels);

calc_values.n_plate_hx_tot_3= calc_n_plate_hx_tot(input_values.m_CaCO3_3, calc_values.m_CaCO3_1hx);
...
% heat capacity flow for one channel
