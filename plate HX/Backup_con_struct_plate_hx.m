...
input_values.theta_plate_in_1=700;
...
input_values.theta_plate_in_3=750;
input_values.p=1e5;
...
input_values.height_plate=0.5;
input_values.width_plate=1;
input_values.n_plates_row=6;
...
save('Test_plates_02.mat', 'constants', 'input_values')
