...
for i=1:length(input_values.t)
   t= input_values.t(i);

[calc_values.alpha(i), calc_values.alpha_WS, calc_values.alpha_beddry] =calc_heat_transfer_coefficient_HTS(...
	calc_values.T,              ...
	input_values.C,             ...
	constants.R,                ...
	input_values.M,             ...
...
calc_values.Q(i)=calc_Q_hx_CaCO3(...
	calc_values.alpha(i),      ...
	calc_values.T_HTS_in,   ...
	calc_values.T_CaCO3_in, ...
...
calc_values.T_HTS_out(i)=calc_T_HTS_out(...
    calc_values.Q(i), 					... 
    calc_values.T_HTS_in,           ...
...
calc_values.T_CaCO3_out(i)=calc_T_CaCO3_out(...
    calc_values.Q(i), 					... 
    calc_values.T_CaCO3_in,           ...
    calc_values.cp_CaCO3,           ...
    calc_values.m_2,                ...
