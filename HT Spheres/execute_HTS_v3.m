...
% load tables and input values

% load('Test_HTS_04.mat')
% 
% load('table_lambda_air')
% load('table_lambda_CaCO3')
...
calc_values.V_void_HTS=calc_V_void_HTS(calc_values.psi_HTS, calc_values.V_HTS_tot_1);

calc_values.n_CaO_add_1=calc_n_p_add(...
    calc_values.V_void_HTS,...
    input_values.d_p...
);

calc_values.n_HTS_1=calc_n_HTS_max(...              %max. Anzahl an HTS für ein gegebene n_CaO (genug Partikel für die Kontaktanzahl N_c12 und Leervolumen)
    calc_values.n_CaO_add_1,...
    input_values.n_CaO_1,...
    calc_values.N_c12_1...
); 

calc_values.A_HTS_1=calc_A_HTS(input_values.d_HTS);
calc_values.A_HTS_tot_1=calc_A_HTS_tot(calc_values.n_HTS_1, calc_values.A_HTS_1);
...
calc_values.V_HTS_tot_1=calc_V_tot(input_values.d_HTS, calc_values.n_HTS_1);
...
% X_d and Y_V
calc_values.X_d_1=calc_X_d(input_values.d_HTS, input_values.d_p);
calc_values.Y_V_1=calc_Y_V(calc_values.n_HTS_1, input_values.n_CaO_1, calc_values.V_HTS_tot_1, calc_values.V_CaO_tot_1);
...
calc_values.A_HTS_3=calc_A_HTS(input_values.d_HTS);
calc_values.A_HTS_tot_3=calc_A_HTS_tot(calc_values.n_HTS_3, calc_values.A_HTS_3);
...
calc_values.V_HTS_tot_3=calc_V_tot(input_values.d_HTS, calc_values.n_HTS_3);
...
% X_d and Y_V
calc_values.X_d_3=calc_X_d(input_values.d_HTS, input_values.d_p);
calc_values.Y_V_3=calc_Y_V(calc_values.n_HTS_3, input_values.n_CaCO3_3, calc_values.V_HTS_tot_3, calc_values.V_CaCO3_tot_3);
